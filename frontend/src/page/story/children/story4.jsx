...
export default function StoryPage4() {
    ...
    return (
        <div className="story-page">
            ...
            <p>Từ những việc làm nhỏ bé như hỏi han chiến sĩ bị ngã, nhường phần ăn, phần nghỉ cho anh em, đến những lời dặn dò ân tình trước lúc chia tay, tất cả đều chứa đựng tấm lòng bao dung, nhân hậu và sâu sắc. Trong trái tim Bác, người chiến sĩ không chỉ là lực lượng bảo vệ Tổ quốc, mà còn là niềm tự hào, niềm tin và những người con thân yêu của đất nước.</p>
            <p>Nhiều câu chuyện, bài viết và tác phẩm như Tấm lòng của Bác, Chú ngã có đau không, Chú sang xông nhà cho Bác chỉ là phần nhỏ trong vô vàn câu chuyện cảm động về tình yêu thương của Bác với bộ đội. Qua những trang viết giản dị nhưng thấm đẫm cảm xúc, người đọc cảm nhận được vị lãnh tụ vĩ đại, luôn sống vì con người, vì hạnh phúc của đồng bào và đồng chí.</p>
            <p>Tình cảm của Bác đối với chiến sĩ bộ đội là minh chứng sống động cho lòng nhân ái vô bờ và tinh thần đoàn kết quân – dân như cá với nước. Nó không chỉ là nguồn động viên lớn lao cho các thế hệ chiến sĩ trong kháng chiến, mà còn là bài học quý giá về tình người, về đạo lý “uống nước nhớ nguồn”, và cách sống yêu thương, sẻ chia mà Bác để lại cho muôn đời sau.</p>
